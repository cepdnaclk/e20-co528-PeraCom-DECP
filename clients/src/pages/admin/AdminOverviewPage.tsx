...
import { Users, Calendar, Briefcase, FlaskConical } from "lucide-react";
...
const DEFAULT_STATS: DashboardStats = {
  users: { value: 105, trend: { value: 10, positive: true } },
  events: { value: 5, trend: { value: 50, positive: true } },
  jobs: { value: 2, trend: { value: 8, positive: true } },
  researches: { value: 4, trend: { value: 15, positive: true } },
};

const CHART_DATA = [
  { name: "Jan", users: 4, events: 0, jobs: 2 },
  { name: "Feb", users: 30, events: 0, jobs: 2 },
  { name: "Mar", users: 20, events: 0, jobs: 2 },
  { name: "Apr", users: 27, events: 9, jobs: 0 },
  { name: "May", users: 19, events: 10, jobs: 25 },
  { name: "Jun", users: 5, events: 15, jobs: 27 },
];
